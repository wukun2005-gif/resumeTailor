...
|------|------|----------|-------------|
| 2026-05-10 | U0/U1 设置弹窗交互修复与精简：①U0 modal-header sticky 定位 + 禁止点击外部关闭弹窗；②U1 设置弹窗改为 tab 切换（模型连接/Agent分配/GitHub/隐私），推理强度下拉隐藏到"高级选项"折叠区，tab 状态持久化 | index.html, src/main.js, src/style.css, DESIGN.md | |
